...
2. In this task, you perform a full database export. In lab 6, *Migration using Data Pump with NFS*, you looked at the object paths included in various export modes. A full export has the most object paths included. Look at the object paths that are part of a full export.
